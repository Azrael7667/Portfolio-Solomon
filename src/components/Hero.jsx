  ...
  return (
    <div>
        ...
        <div className=' flex-col my-auto'>
            <p className='md:text-5xl sm:text-4xl text-xl font-bold text-gray-500 '>Hi I'm Solomon</p>
            ...
            <div className='flex items-center justify-center '>
                <p className='md:text-5xl sm:text4xl text-xl font-bold text-gray-500'>with a 5+ years experience</p>
            </div>
        ...
        <div className='my-auto'>
            <img className='w-[300px] sm:w-[500px] mx-auto rounded-full' src={profilepic} alt="profile pic"/>
        </div>
